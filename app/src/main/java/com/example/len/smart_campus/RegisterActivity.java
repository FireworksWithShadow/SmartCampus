...
public class RegisterActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPasswordViewAgain = (EditText) findViewById(R.id.register_password_again);
    ...
    private void attemptRegister() {
        ...
        if (!password.equals(passwordAgain) ) {
            mPasswordViewAgain.setError(getString(R.string.error_password_confirm));
    ...
    public  void LoginRequest(final String account, final String password) {
        //请求地址
        String url = "http://39.105.175.211:8080/loginweb/RegisterServlet?account="+account+"&password="+password;
        String tag = "Login";
